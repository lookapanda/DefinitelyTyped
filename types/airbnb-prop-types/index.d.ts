...
export type ReactComponent = (...args: any[]) => any;
...
export function childrenOfType(...types: Array<Validator<any>>): Requireable<any>;
...
export function elementType(type: '*' | string | ReactComponent): Requireable<any>;
